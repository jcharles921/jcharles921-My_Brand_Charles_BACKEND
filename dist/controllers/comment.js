    ...
    _createClass(Comment, null, [
        {
            ...
            value: function createComment(req, res) {
                return _asyncToGenerator(function() {
                    var id, _req_body, username, message, Post, error;
                    return __generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                id = req.params.id;
                                _req_body = req.body, username = _req_body.username, message = _req_body.message;
                                _state.label = 1;
                            case 1:
                                _state.trys.push([
                                    1,
